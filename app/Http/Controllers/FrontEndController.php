...
class FrontEndController extends Controller
{
    ...
    /*public function shop(Request $request, $cat_id){
        //dd($request->cat_id);
    ...
    public function mytableAjax($id) {
        $products = Product::where('pro_cate', $id)->get();
        return json_encode($products);
    }
    
    public function productdetailsshop(){
        $getproductsfromshop = Product::paginate(12);
        return view('website.product-details', compact('getproductsfromshop'));
    }
