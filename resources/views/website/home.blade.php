            ...
            <div class="col-lg-4 mb-4">
                <div class="entry2">
                    <a href="{{ route('website.post', ['slug' => $post->slug]) }}">
                        <img src="http://localhost/larablog/public{{ $post->image }}" alt="Image" class="img-fluid rounded"> 
                      </a>
                    <div class="excerpt">
        ...
        <div class="row align-items-stretch retro-layout">
            ...
            <div class="col-md-7">
                ...
                <div class="two-col d-block d-md-flex justify-content-between">
                    ...
                    <a href="{{ route('website.post', ['slug' => $post->slug]) }}"
                        class="hentry v-height img-2 gradient" style="background-image: url('{{ url($post->image) }}');">
