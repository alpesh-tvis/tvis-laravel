      ...
      <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1200px;">
         <div class="owl-item active" style="width: 1903px;height: 100%;">
            <div class="item"><img src="http://localhost/larablog/public/website/images/img_1.jpg" alt="" style="width: 100%;height: 100%;">
                <div class="centered"><h3>{{ $productdetails->name }}</h3>
                  <p><a href="{{ URL::to('/') }}">Home</a> >> <a href="{{ URL::to('/shop') }}">Shop</a> >> {{ $productdetails->name }}</p>
                </div>
            </div>
         </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            ...
                            <h4><del>{{ $productdetails->currency }} {{ $productdetails->sale_price }}</del><span>55% off</span></h4>
                            <h3>{{ $productdetails->currency }} {{ $productdetails->regular_price }}</h3>
                            ...
                            <div class="product-description border-product">
                                ...
                                <div class="qty-box">
                                    ...
                                    <input type="number" value="{{ $productdetails->quantity }}" class="form-control qty-nums quantity update-carts" />
                                </div>
                            </div>
                            <div class="product-buttons">
                            <button type="button" class="btn bg-cart"><a href="{{ route('add_to_cart', $productdetails->id) }}" class="btn btn-solid addtocart"><i class="fa fa-cart-plus mr-2"></i> Add to cart</a></button>
                               <!--  <a href="{{ route('add_to_cart', $productdetails->id) }}" data-toggle="modal" data-target="#addtocart" class="btn btn-solid addtocart">add to cart</a> --> 
                                <button type="button" class="btn bg-cart"><a href="" class="btn btn-solid addtocart">buy now</a></button>
...
<!-- product section start -->
    <section class="section-b-space ratio_asos">
        <div class="container">
            ...
            <?php //dd($relatedproduct); ?>
            <div class="row search-product">
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="https://images-na.ssl-images-amazon.com/images/I/61paqOv2LuL._AC_UX569_.jpg"
                            ...
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart">
                                    <i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)"
...
$(".update-carts").change(function () {
    //e.preventDefault();
    var qval = $(this);
       //alert(qval);
        if(confirm("Do you really want to update quantity?")) {
        $.ajax({
            url: '{{ route('website.update-carts') }}',
                method: "patch",
                data: {
                    _token: '{{ csrf_token() }}', 
