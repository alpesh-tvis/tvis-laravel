...
@section('content')
    <div class="py-5 bg-light" style="background-image: url('{{ asset($category->image) }}'); background-position: center;
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-4">
            <div class="entry2">
              <a href="{{ route('website.post', ['slug' => $post->slug]) }}"><img src="{{ url($post->image) }}" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
